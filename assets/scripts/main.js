...
$(document).ready(function () {
    ...
    $('.new-form__add').on('click', function(e){
        ...
        // $(this).parents('.new-form__pacient').append(html);
        $('._second').fadeIn(300);
        $(this).hide();
        $( ".new-form__select" ).selectmenu("refresh");
    });
